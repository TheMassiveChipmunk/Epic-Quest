...
Venom::Engine::Engine (sf::IntRect& BasePosition ,
...
Venom::BulletEngine::BulletEngine (sf::IntRect& BasePosition ,
				   float SpeedX , float SpeedY ,
				   sf::RenderWindow& Window)
    :Engine (BasePosition , SpeedX , 
	     SpeedY , Window)
{
}
...
Venom::PlayerEngine::PlayerEngine (sf::IntRect& BasePosition , float SpeedX , 
				   float SpeedY , float BulletSpeedX , 
				   float BulletSpeedY , sf::RenderWindow& Window)
    :Engine (BasePosition , SpeedX , 
	     SpeedY , Window) ,
     Bullets (BasePosition , BulletSpeedX , 
	      BulletSpeedY , Window)
{
}
...
Venom::EnemyEngine::EnemyEngine (sf::IntRect& BasePosition , 
				 float SpeedX , float SpeedY ,
				 float BulletSpeedX , float BulletSpeedY ,
				 sf::RenderWindow& Window)
    :PlayerEngine (BasePosition , SpeedX , 
		   SpeedY , BulletSpeedX , 
		   BulletSpeedY , Window)
{
}
...
void Venom::EnemyEngine::handleEvents ()
{
	...
	this->BasePosition->Height)
    {
	this->BasePosition->Top = 40.0f;
	this->BasePosition->Left = 40.0f;
    }
